...
interp.configureCompiler(x => x.settings.source.value = scala.tools.nsc.settings.ScalaVersion("2.12"))
...
/*Old-version*/
//import $ivy.`edu.berkeley.cs::chisel3:3.2.+`
...
/*
  Applied version
  All the version information can be found at https://repo1.maven.org/maven2/edu/berkeley/cs
*/
import $ivy.`edu.berkeley.cs::chisel3:3.5.0-RC1`
import $ivy.`edu.berkeley.cs::chisel-iotesters:2.5.0-RC1`
import $ivy.`edu.berkeley.cs::chiseltest:0.5.0-RC1`
import $ivy.`edu.berkeley.cs::dsptools:1.5.0-RC1`
import $ivy.`org.scalanlp::breeze:2.0.1-RC1`
import $ivy.`edu.berkeley.cs::rocket-dsptools:1.2.6`
import $ivy.`edu.berkeley.cs::firrtl-diagrammer:1.5.0-RC1`
import $ivy.`org.scalatest::scalatest:3.2.2`
